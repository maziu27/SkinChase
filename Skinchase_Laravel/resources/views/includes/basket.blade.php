...
<div class="relative" id="basket-wrapper">
    <!-- Sidebar de la Cesta -->
    <div id="basket-sidebar"
        class="origin-top-right absolute right-0 mt-2 w-80 bg-gray-900 text-white rounded-md shadow-lg transform scale-95 opacity-0 transition-all duration-300 pointer-events-none z-50">
