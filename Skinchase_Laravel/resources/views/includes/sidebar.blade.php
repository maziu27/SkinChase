...
<div id="sidebar" class="bg-[#1e1e1e] p-5 w-[300px] rounded-[10px]">
    ...
    <form action="#" method="post" class="space-y-4">
        ...
        <div class="space-y-2">
            <input type="text" placeholder="Sticker Slot 1" name="name" required class="w-full p-2 rounded bg-gray-700 border border-gray-600 focus:ring-2 focus:ring-blue-500">
            <input type="text" placeholder="Sticker Slot 2" name="floatFrom" class="w-full p-2 rounded bg-gray-700 border border-gray-600">
            <input type="text" placeholder="Sticker Slot 3" name="floatTo" class="w-full p-2 rounded bg-gray-700 border border-gray-600">
            <input type="text" placeholder="Sticker Slot 4" name="priceFrom" class="w-full p-2 rounded bg-gray-700 border border-gray-600">
            <input type="text" placeholder="Sticker Slot 5" name="priceTo" class="w-full p-2 rounded bg-gray-700 border border-gray-600">
        </div>
