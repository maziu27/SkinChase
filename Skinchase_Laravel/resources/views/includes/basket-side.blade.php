...
<div id="basket-sidebar"
    class="absolute right-0 mt-2 w-60 bg-gray-900 text-white rounded-md shadow-lg transform scale-95 opacity-0 transition-all duration-300 pointer-events-none z-50">
