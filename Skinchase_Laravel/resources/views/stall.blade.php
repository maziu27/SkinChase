...
@section('content')
    ...
    <div class="container mx-auto px-4">
        <div id="inventory-container" class="grid gap-4 xl:grid-cols-6 lg:grid-cols-5 md:grid-cols-3 sm:grid-cols-3 grid-cols-2"></div>
    </div>

    <script>
        // Pass the user ID from server to client
